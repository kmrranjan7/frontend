...
export function SavedJobsHeaderButton() {
  ...
  return (
    <div ref={popoverRef} className="relative shrink-0">
      ...
      {open ? (
        <section className="header-action-popover overflow-hidden rounded-lg border border-rose-100 bg-white shadow-[0_18px_45px_rgba(15,23,42,0.2)]" aria-label="Saved jobs">
